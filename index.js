...
Yobit.prototype.signMessage = function getMessageSignature (params) {
  ...
  let hash = crypto.createHmac('sha512', this.secret)
  hash.update(data)
...
Yobit.prototype.getTicker = function getTicker (pair, callback) {
  this.publicRequest('ticker/' + pair, {currencyPair: pair}, callback)
}

Yobit.prototype.getOrderBook = function getOrderBook (pair, limit, callback) {
  var params = {
    currencyPair: pair,
    limit: 1000
  }
...
Yobit.prototype.getTrades = function getTrades (pair, limit, callback) {
  var params = {
    currencyPair: pair,
    limit: 1000
  }
...
Yobit.prototype.getKline = function getKline (symbol, type, size, since, callback) {
...
Yobit.prototype.getLendDepth = function getLendDepth (symbol, callback) {
...
Yobit.prototype.addTrade = function addTrade (symbol, type, amount, price, callback) {
  var params = {
    symbol: symbol,
    type: type
  }
...
Yobit.prototype.addBatchTrades = function addBatchTrades (symbol, type, orders, callback) {
...
Yobit.prototype.getAccountRecords = function getAccountRecords (symbol, type, current_page, page_length, callback) {
...
Yobit.prototype.getOrderHistory = function getOrderHistory (symbol, status, current_page, page_length, callback) {
...
Yobit.prototype.addWithdraw = function addWithdraw (symbol, chargefee, trade_pwd, withdraw_address, withdraw_amount, callback) {
...
Yobit.prototype.cancelWithdraw = function cancelWithdraw (symbol, withdraw_id, callback) {
